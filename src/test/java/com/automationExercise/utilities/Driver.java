...
//                    WebDriverManager.getInstance(SafariDriver.class).setup();
                ...
                case "remote_chrome":
                    ...
                    try {
                        driverPool.set(new RemoteWebDriver(new URL("http://localhost:4444"),chromeOptions)); // run with standalone chrome docker, without Grid
                        //driverPool.set(new RemoteWebDriver(new URL("http://18.212.6.39:4444/wd/hub"),chromeOptions));
                        //driverPool.set(new RemoteWebDriver(new URL("saucelab/account/userSetting/driverCreationCopyAndPass"),chromeOptions));
